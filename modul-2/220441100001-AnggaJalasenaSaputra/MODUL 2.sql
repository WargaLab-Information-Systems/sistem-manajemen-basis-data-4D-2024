...
VALUES
    (1, 'Kaos Pendek', 10000, 5),
    (2, 'Kemeja Kotak', 15000, 6),
    (3, 'Kaos Pollo', 20000, 8),
    (4, 'Celana Pendek Levis', 25000, 3),
    (5, 'Celana Panjang Levis', 30000, 15),
    (6, 'Celana Jeans Biasa', 35000, 4),
    (7, 'Celana Cargo', 40000, 3);
...
VALUES 
(1, 'Angga Jalasena', 'anggajs@gmail.com', 'Jl. Munawir No. 99, Malang'),
(2, 'Imam Arishandi', 'imam_aja@gmail.com', 'Jl. Martajesah No. 20, Bangkalan'),
(3, 'Bintang Wahyu', 'bintangstar@gmail.com', 'Jl. Sumber Sari No. 30, Sidoarjo'),
(4, 'Irfan Faruq', 'ipunk@gmail.com', 'Jl. Lakarsantri No. 40, Surabaya'),
(5, 'Aditya Putri', 'dita@gmail.com', 'Jl. Sumber Kepuh No. 50, Nganjuk');
