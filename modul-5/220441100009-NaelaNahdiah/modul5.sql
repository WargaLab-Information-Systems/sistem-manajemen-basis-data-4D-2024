...
drop DATABASE toko_modul5;
	...
	VALUES
	(1, 1, 1, 50, '2024-05-10 08:00:00'),
	(2, 2, 1, 100, '2024-05-11 08:00:00'),
	(3, 3, 1, 200, '2024-05-12 08:00:00'),
	(4, 4, 1, 150, '2024-05-13 08:00:00'),
	...
	VALUES
	(1, 1, 1, 1, 10, 100000, '2024-05-14 09:00:00'),
	(2, 2, 1, 2, 20, 100000000, '2024-05-14 09:00:00'),
	(3, 3, 2, 3, 30, 90000, '2024-05-14 09:00:00'),
    ...
    (12, 5, 1, 1, 5, 50000, '2024-05-12 09:00:00');
...
SET @totalHarga = 0;
CALL hitung_total_harga_transaksi(2, @totalHarga);
