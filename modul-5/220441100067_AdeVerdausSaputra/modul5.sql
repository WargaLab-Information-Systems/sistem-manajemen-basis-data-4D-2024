...
VALUES 
('Laptop ASUS', 'Elektronik', 8000000.00, 2.5),
('Sepatu Adidas', 'Fashion', 500000.00, 0.8),
('Meja Belajar', 'Furniture', 1000000.00, 10),
('Buku Matematika', 'Buku', 75000.00, 0.5),
('Pensil 2B', 'Alat Tulis', 5000.00, 0.1),
('Celana Jeans', 'Fashion', 300000.00, 0.7),
('Printer Epson', 'Elektronik', 1500000.00, 5),
('Kursi Kantor', 'Furniture', 2000000.00, 15),
('Mouse Wireless', 'Elektronik', 100000.00, 0.2),
('Buku Catatan', 'Buku', 25000.00, 0.3);
...
VALUES 
(1, 'Budi', 'Jl. Merdeka No. 1', 'Manager', 10000000.00),
(1, 'Ani', 'Jl. Gatot Subroto No. 5', 'Staff', 7000000.00),
(2, 'Cici', 'Jl. Pangeran Diponegoro No. 15', 'Staff', 7000000.00),
(2, 'Doni', 'Jl. Pangeran Diponegoro No. 25', 'Staff', 7000000.00),
(3, 'Eva', 'Jl. Ahmad Yani No. 35', 'Manager', 10000000.00),
(3, 'Feri', 'Jl. Ahmad Yani No. 45', 'Staff', 7000000.00);
...
VALUES 
(1, 1, 1, 1, 100000.00, NOW()),
(2, 2, 2, 20, 150000.00, NOW()),
