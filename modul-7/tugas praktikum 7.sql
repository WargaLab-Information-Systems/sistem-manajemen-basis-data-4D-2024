...
('Nissan', 'Alphard', 2017, 'Putih', 450000.00, 'Tidak Tersedia');

INSERT INTO perawatan (id_mobil, tanggal, deskripsi, biaya) VALUES
(1, '2023-01-15', 'Ganti oli', 180000.00),
(2, '2023-02-20', 'Perbaikan rem', 350000.00),
(3, '2023-03-10', 'Penggantian ban', 420000.00),
(4, '2023-04-25', 'Servis AC', 300000.00),
(5, '2023-05-05', 'Tune up mesin', 390000.00);

INSERT INTO pelanggan (nama, alamat, no_telepon, email) VALUES
('Sindy', 'Jl. Mawar No. 10', '081234567890', 'sindyw@gmail.com'),
('Aprilia', 'Jl. Melati No. 20', '081234567891', 'apriliaa@gmail.com'),
('Tyas', 'Jl. Kenanga No. 30', '081234567892', 'tyas66@gmail.com'),
('Nayla', 'Jl. Anggrek No. 40', '081234567893', 'naylaa@gmail.com'),
('Hanifa', 'Jl. Tulip No. 50', '081234567894', 'hanifa01@gmail.com');

INSERT INTO pegawai (nama, jabatan, no_telepon, email) VALUES
('Joko', 'Manager', '082334567895', 'joko@gmail.com'),
('Farhan', 'Sales', '085434567896', 'farhan@gmail.com'),
('Leli', 'Receptionist', '089834567897', 'leli@gmail.com'),
('Imron', 'Assistant Manager', '081234567898', 'imron@gmail.com'),
('Dika', 'Sales', '086234567899', 'dika@gmail.com');
