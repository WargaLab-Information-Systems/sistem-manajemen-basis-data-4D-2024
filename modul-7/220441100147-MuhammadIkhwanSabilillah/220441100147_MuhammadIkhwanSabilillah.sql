CREATE DATABASE penyewaan_mobill;
USE penyewaan_mobill;
...
('Toyota', 'Fortuner', 2020, 'Putih', 500000.00, 'Tersedia'),
...
('Isuzu', 'Panther', 2018, 'Biru', 450000.00, 'Tidak Tersedia');
...
('Budi Santoso', 'Jl. Mawar No. 10', '081234567890', 'budi@example.com'),
('Siti Aminah', 'Jl. Melati No. 20', '081234567891', 'siti@example.com'),
('Rina Setiawan', 'Jl. Kenanga No. 30', '081234567892', 'rina@example.com'),
('Andi Wijaya', 'Jl. Anggrek No. 40', '081234567893', 'andi@example.com'),
('Dewi Lestari', 'Jl. Tulip No. 50', '081234567894', 'dewi@example.com');


INSERT INTO pegawai (nama, jabatan, no_telepon, email) VALUES
('Adi', 'Manager', '081234567895', 'adi@example.com'),
('Budi', 'Sales', '081234567896', 'budi@example.com'),
('Citra', 'Receptionist', '081234567897', 'citra@example.com'),
('Dedi', 'Assistant Manager', '081234567898', 'dedi@example.com'),
('Eka', 'Sales', '081234567899', 'eka@example.com');
...
VALUES (2, '2023-06-04', 2000000.00, 'Transfer Bank');
...
BEGIN
    ...
    -- Dapatkan harga sewa per hari dari tabel mobil
...
VALUES (1, 2, 3, '2023-06-09', '2023-06-11', 'Belum Selesai');
