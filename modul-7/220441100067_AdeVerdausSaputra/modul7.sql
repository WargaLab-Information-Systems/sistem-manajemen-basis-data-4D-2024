...
('Nissan', 'Juke', 2017, 'Biru', 450000.00, 'Tidak Tersedia');
...
('John Doe', 'Jl. Mawar No. 10', '081234567890', 'john@example.com'),
('Jane Smith', 'Jl. Melati No. 20', '081234567891', 'jane@example.com'),
('Alice Brown', 'Jl. Kenanga No. 30', '081234567892', 'alice@example.com'),
('Bob Johnson', 'Jl. Anggrek No. 40', '081234567893', 'bob@example.com'),
('Charlie Davis', 'Jl. Tulip No. 50', '081234567894', 'charlie@example.com');

INSERT INTO pegawai (nama, jabatan, no_telepon, email) VALUES
('Michael Scott', 'Manager', '081234567895', 'michael@example.com'),
('Jim Halpert', 'Sales', '081234567896', 'jim@example.com'),
('Pam Beesly', 'Receptionist', '081234567897', 'pam@example.com'),
('Dwight Schrute', 'Assistant Manager', '081234567898', 'dwight@example.com'),
('Stanley Hudson', 'Sales', '081234567899', 'stanley@example.com');
...
WHERE id_transaksi = 12;

INSERT INTO transaksi (id_pelanggan, id_mobil, id_pegawai, tanggal_mulai, tanggal_selesai, total_biaya, status_transaksi) VALUES
(3, 3, 1, '2024-06-05', '2024-06-07', 2000000.0, 'Belum Selesai');
...
VALUES (10, '2023-06-05', 0, 'Transfer Bank');
...
VALUES (3, 4, 4, '2024-06-05', '2024-06-07', 'Belum Selesai');
