...
INSERT INTO pegawai (nama, jabatan, no_telepon, email) VALUES
	('Tom Haye', 'Manager', '081234567890', 'Haye@gmail.com'),
	('Ernando', 'Supervisor', '081298765432', 'ERnando@gmail.com'),
	('Zahra Muz', 'Staff', '081212345678', 'Zahmuz@gmail.com'),
	('Nathan joe', 'Clerk', '081276543210', 'Nathan.joe@gmail.com'),
	('Asnawi Mangkulam', 'Administrator', '081234098765', 'Mangkulam@gmail.com'),
    ('Elkan Baggot', 'Manager', '081234567891', 'Elkan@gmail.com'),
	('Tokyo', 'Supervisor', '081298765433', 'Kaktokyo@gmail.com'),
	('Bobon Santoso', 'Staff', '081212345679', 'Bobon.Santoso@gmail.com'),
	('Ezra Wallian', 'Clerk', '081276543211', 'Ezra.Wallian@gmail.com'),
	('Arhan Pratama', 'Administrator', '081234098766', 'Arho@gmail.com');
SELECT * FROM pegawai;
...
INSERT INTO pelanggan (nama, alamat, no_telepon, email) VALUES
	('Oxa Indi', 'Jl. Merdeka No. 45, Jakarta', '081234567890', 'Oxaoxa@gmail.com'),
	('Naela Nahdiah', 'Jl. Sudirman No. 10, Bandung', '081298765432', 'NaelaNah@gmail.com'),
	('Tesa Hutagaol', 'Jl. Diponegoro No. 20, Surabaya', '081212345678', 'tesa@gmail.com'),
	('Bintang Cahyo', 'Jl. Gatot Subroto No. 15, Medan', '081276543210', 'bintang@gmail.com'),
	('Sifa Saputra', 'Jl. Thamrin No. 5, Yogyakarta', '081234098765', 'sifa@gmail.com'),
    ('Khoirotun nisa', 'Jl. Dipatiukur No. 30, Bandung', '081234567891', 'Khoirotun@gmail.com'),
	('Imam Arisandi', 'Jl. Ahmad Yani No. 25, Surabaya', '081298765433', 'Imam@gmail.com'),
	('Amelia Zalfa', 'Jl. Raden Saleh No. 35, Jakarta', '081212345679', 'Amelia Zalfa@gmail.com'),
	('Izzudin Arafat', 'Jl. Pahlawan No. 40, Semarang', '081276543211', 'Izzudin Arafat@gmail.com'),
	('Shulton', 'Jl. A. Yani No. 50, Malang', '081234098766', 'Shulton@gmail.com');
...
SELECT * FROM transaksi;
SELECT * FROM mobil;
SELECT * FROM mobil WHERE id_mobil = (SELECT id_mobil FROM transaksi WHERE id_transaksi = 1);
