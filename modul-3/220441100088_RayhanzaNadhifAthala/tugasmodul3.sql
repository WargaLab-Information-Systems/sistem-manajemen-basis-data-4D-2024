...
VALUES
('P001', 'admin', 'rahasia', 'Budi'),
('P002', 'Ani1', 'cuma', 'Anisa'),
('P003', 'Pass', 'passw', 'Nadhif'),
('P004', 'Akmal4', 'word', 'Akmal'),
('P005', 'B1rurr', 'untuk', 'Birrur'),
('P006', 'Fiqijr', 'tugas', 'Fiqi'),
('P007', 'Juann', 'smbd', 'Juan'),
('P008', 'Rulls', 'praktikum', 'Dani'),
('P009', 'Konoha', 'semester', 'Reyhan'),
('P010', 'saigma', 'empat', 'Sigma');
...
DELIMITER //
CREATE PROCEDURE soal1(IN nama VARCHAR(20))
BEGIN
    SELECT *
    FROM Petugas
...
CREATE PROCEDURE soal2(IN nama VARCHAR(20))
BEGIN
    SELECT *
    FROM anggota
...
CALL nomer7('2024-04-02', 'MB002', @jumlah);

SELECT @jumlah AS Jumlah_Peminjam;

drop procedure nomer7;

select * from peminjaman;

INSERT INTO peminjaman (kode_peminjaman, id_petugas, kode_buku, Tanggal_Pinjam, Tanggal_Kembali, id_anggota) 
VALUES ('10', 'P010', 'MB010', '2024-04-10', '2024-04-24', 'R010');
