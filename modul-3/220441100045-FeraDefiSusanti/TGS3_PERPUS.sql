...
END //
DELIMITER ;
CALL peminjaman_by_tanggal_dan_kode('2024-04-01', 'BK001');
...
END //
DELIMITER ;
CALL anggota_by_kriteria('2019', 'Jakarta', 'Perempuan');
...
END //
DELIMITER ;
CALL insert_anggota('AGT011', 'sinta putri', '2022', 'Jakarta','2001-05-12', 81234564545, 'Perempuan', 'Pinjam');
select*FROM anggota;
...
END //
DELIMITER ;
CALL jumlah_anggota(@jumlah);
SELECT @jumlah AS 'Total Anggota';
