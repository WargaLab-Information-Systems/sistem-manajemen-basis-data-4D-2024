...
CREATE OR REPLACE PROCEDURE soal3 (OUT total_stok INT)
BEGIN
SET total_stok = 9 (SELECT SUM(stok_barang) FROM barang)
...
IN nama_suplier
IN alamat_suplir VARCHAR (100),
IN telepon_suplir VARCHAR (100)
)
BEGIN
INSERT INTO suplier (nama_suplier,alamat_suplier,telepon_suplier)
...
-- soal 5--
CREATE OR REPLACE PROCEDURE soal5(
IN pembeli_id INT (11),
IN nama-pembeli VARCHAR (100),
IN alamat_pembeli VARCHAR (200),
IN telepon_pembeli VARCHAR (200),
