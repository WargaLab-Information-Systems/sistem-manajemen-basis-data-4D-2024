...
-- mendfenisikan stored procedure
-- soal 1
DELIMITER//
...
BEGIN 
SELECT * FROM transaksi WHERE DATE_SUB('2024-04-06' , INTERVAL  5 DAY) AND jumlah_barang >1 GROUP BY tanggal_transaksi;
END//
DELIMITER ;
...
BEGIN
SELECT SUM(stok_barang) INTO totalstok FROM barang;
END//

DELIMITER ;
CALL soal3(@totalstok)
...
BEGIN
INSERT INTO supplier(supplier_id, nama_supplier, alamat_supplier, telepon_supplier) VALUES (supplier_id, nama_supplier, alamat_supplier, telepon_supplier);
END//
