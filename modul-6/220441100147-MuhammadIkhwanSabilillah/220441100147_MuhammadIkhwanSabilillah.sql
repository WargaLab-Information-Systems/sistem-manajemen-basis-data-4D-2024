...
(1, 'Proyek 1', 'Tech Solutions', '2024-01-15', '2024-09-30'),
(2, 'Proyek 2', 'Innovative Labs', '2024-05-15', '2024-06-09'),
(3, 'Proyek 3', 'Future Enterprises', '2024-05-09', '2024-06-07'),
(4, 'Proyek 4', 'Creative Minds', '2024-05-05', '2024-12-25'),
(5, 'Proyek 5', 'Smart Innovations', '2024-04-20', '2024-09-10');

INSERT INTO employees (employee_id, nama, position, salary, date_hired, project_id) VALUES
(1, 'Andre', 'Software Engineer', 600000.00, '2022-01-15', 1),
(2, 'Gilang', 'Data Analyst', 550000.00, '2020-07-20', 2),
(3, 'Anggi', 'Project Manager', 750000.00, '2020-03-25', 3),
(4, 'Jonathan', 'System Administrator', 500000.00, '2019-11-10', 4),
(5, 'Agus', 'Quality Assurance', 480000.00, '2024-04-21', 5);
...
drop database OutsourcingCompanyy;
-- soal 1
DELIMITER //
