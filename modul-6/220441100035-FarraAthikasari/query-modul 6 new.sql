...
BEGIN
    ...
    -- Mendeklarasikan cursor cur untuk mengambil employee_id dll
    ...
    read_loop: LOOP
        ...
        -- Mengecek apakah karyawan telah bekerja selama minimal satu tahun
...
BEGIN
    ...
    read_loop: LOOP
        ...
        -- Mengecek apakah proyek akan berakhir dalam waktu kurang dari 30 hari
...
BEGIN
    ...
    read_loop: LOOP
        ...
        -- Periksa apakah durasi pelatihan lebih besar dari 0
